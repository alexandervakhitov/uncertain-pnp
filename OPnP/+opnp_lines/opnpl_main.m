function [R0 t0] = opnpl_main(U,u,Xs, Xe, l2d, label_polish)
    ...
    nlines = size(Xs, 2);
    Xsm = Xs;% - repmat(Ucent,1,nlines);
    Xem = Xe;% - repmat(Ucent,1,nlines);
    ...
    [xx yy zz tt] = opnp_orig.GB_Solver_3Order_4Variable_Symmetry(coeff1, coeff2, coeff3, coeff4);
