function [Xsn, Xen] = moveLineCloser2DVector(Xsi, Xei, xs, xe)
    LcUnNormed = cross(Xsi, Xei);
    line_norms = sqrt(LcUnNormed(1,:).^2 +  LcUnNormed(2,:).^2);
    Lc = LcUnNormed./repmat(line_norms, 3, 1);
