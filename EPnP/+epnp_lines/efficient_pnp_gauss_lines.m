function [R,T,Xc,best_solution,opt,t1,t2,t3,t4]=efficient_pnp_gauss_lines(x3d_h,x2d_h,Xs, Xe, xs, xe, A, l2d, lnc)
...
t0 = tic;
%Compute M
Km = epnp_lines.compute_M_ver3(U, Alph, A, Alph_S, Alph_E, l2d, lnc);
t1 = toc(t0);
...
if (length(Xw) < 3)
    [Cc,Xc,sc] = epnp_lines.compute_norm_sign_scaling_factor(X1,Alph_S, SUac, norm_cw);
    ...
    [Cc,Xc,sc] = epnp_lines.compute_norm_sign_scaling_factor(X1,Alph, SUac, norm_cw);
