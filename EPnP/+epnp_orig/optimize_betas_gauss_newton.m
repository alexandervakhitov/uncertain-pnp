...
[Beta_opt,err,iter]=epnp_orig.gauss_newton(Km,Cw,Beta0);
...
s_Cw=epnp_orig.sign_determinant(Cw);
s_Cc=epnp_orig.sign_determinant(Cc);
Cc=Cc*(s_Cw/s_Cc);

%Reconstruct and compute error=
Xc_opt=Alph*Cc; %reconstruction: points in camera coordinate system
[R_opt,T_opt]=epnp_orig.getrotT(Xw,Xc_opt);  %solve exterior orientation
