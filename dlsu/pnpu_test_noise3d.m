function pnpu_test_noise3d
    addpath('../');
    addpath('../dls_pnp_matlab');
    addpath('../p3p_code_final');
    addpath('../EPnP_matlab/EPnP');

    method_list = {@p3p_pnpu, @dls_pnpu, @dlsu_pnpu, @epnp_pnpu, @epnpu_pnpu, @mlpnp_pnpu};   
    ...
    noises_3d = [0.01, 0.1, 0.3, 0.5, 0.7, 0.9];
   ...
   save('noise3d_report.mat', 'report', 'method_labels', 'noises_3d');
end