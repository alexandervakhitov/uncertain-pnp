function [R,t,ff, s] = EPnPLU(Xw,xx,xs, xe, Xs, Xe, Sigmas3D, Sigmas2D, l, Sigmas3DLines, Sigmas2DLines, Rest, test)
    ff = 0;
    t0 = tic;
...
%     Xe = Xs + Xd;
    ...
    t1 = toc(t0);
    t0 = tic;
    [R,t,~,~,~,elt1,elt2,elt3,elt4]= efficient_pnp_gauss_lines_unc(Xw, xx, ...
                                    Xs, Xe, xs, xe, diag([1 1 1]), l2d, ...
                                    Sigmas3D, Sigmas2D, ...
                                    Sigmas3DLines, Sigmas2DLines, Rest, test, true);  
    t2 = toc(t0);
    t0 = tic;
