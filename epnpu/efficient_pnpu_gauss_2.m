...
function [R,T,viz_sigmas,Xc,best_solution,opt]=efficient_pnpu_gauss_2(x3d_h, x2d_h, A, ...
    Sigmas3D, Sigmas2D, Xs, Xe, l2d, Sigmas3DLines, Sigmas2DLines, Rest, test)

Xw=x3d_h(:,1:3);
U=x2d_h(:,1:2);

THRESHOLD_REPROJECTION_ERROR=0.02;%error in degrees of the basis formed by the control points. 
...
%Compute M
tic;
[M, viz_sigmas] = epnp_unc.compute_M_uncertain(U,Alph,A, Sigmas3D, Sigmas2D, Cw, Rest, ...
