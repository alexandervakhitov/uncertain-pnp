function [R,T,Xc,best_solution,opt]=efficient_pnpu_au_gauss(x3d_h,x2d_h,A,Sigmas3D,Sigmas2D,Rest,test,is_pca)
...
%points)
[Alph, Sigmas3DAlph] = compute_alphas(Xw,Cw);

%Compute M
%M=compute_M_uncertain(U,Alph,A, Sigmas3D, Sigmas2D, Cw, Rest, test)
M=compute_M_uncertain(U,Alph,A, Sigmas3D, Sigmas2D, Cw, Rest, test );
